...
<ol>
    ...
    <li><strong>Refund Eligibility</strong></br>Refunds may be granted under the following circumstances:</li>
    <ul>
        <li><strong>Project Cancellation by the Client</strong></li>
        <ul>
            ...
            <li>If the project is canceled after work has commenced, the refund will be calculated based on the stage of project completion and any work already delivered.
</li>
        </ul>
        <li><strong>Failure to Deliver as Agreed</strong></li>
        <ul>
